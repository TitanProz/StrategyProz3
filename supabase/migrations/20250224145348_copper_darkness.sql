/*
  # Fix admin functions with proper column references

  1. Changes
    - Update admin functions to use proper table aliases and column references
  ...
  2. Security
    ...
    - Preserve proper search path settings
*/
